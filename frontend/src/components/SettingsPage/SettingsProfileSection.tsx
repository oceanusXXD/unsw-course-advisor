...
const SettingsProfileSection: React.FC<Props> = ({ user }) => {
    ...
    return (
        <section className="space-y-4">
            ...
            <div
                className="flex flex-col sm:flex-row items-start gap-6 p-6 rounded-xl bg-white dark:bg-neutral-800 
            border border-neutral-200 dark:border-neutral-700 shadow-sm"
            >
                {/* Avatar */}
                <div className="relative group flex-shrink-0">
                    <div
                        className="w-24 h-24 rounded-full bg-gradient-to-br from-yellow-400 to-yellow-500 flex
                     items-center justify-center text-black text-4xl font-bold overflow-hidden"
                    >
