      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-8 relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {!isLogin && (
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-cyan-400 transition disabled:bg-gray-100"
                disabled={isLoading}
              />
            </div>
          )}
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-2 bg-cyan-400 text-white font-semibold rounded-lg hover:bg-cyan-500 transition disabled:bg-gray-400 disabled:cursor-not-allowed mt-6"
          >
            {isLoading ? (
